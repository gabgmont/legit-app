...
import { Paperclip, ArrowLeft, QrCode } from "lucide-react"
import Link from "next/link"

export default function VerifyAuthenticityPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#050810] text-white">
      ...
      <div className="flex-1 flex flex-col px-6 pt-4 pb-8">
        ...
        {/* Verify Button */}
        {verificationMethod && (
          <button className="w-full bg-[#4169e1] text-white py-3 rounded-md font-medium mt-6">Verify</button>
        )}
