  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-[#050810] text-white">
      ...
      <div className="flex-1 flex flex-col px-8 pt-12 pb-8">
        ...
        <p className="text-lg text-gray-300 mb-10">Choose an authentication method</p>
        ...
        >
          <div className="w-24 h-24 mb-4 flex items-center justify-center">
            <Image src="/images/qr-code.png" alt="QR code scanner" width={120} height={120} priority />
          </div>
        ...
        >
          <div className="w-24 h-24 mb-4 flex items-center justify-center">
            <Image src="/images/nfc.png" alt="NFC tag" width={120} height={120} priority />
          </div>
        ...
        <div className="mt-auto">
          {/* Go Back Button */}
          <button onClick={handleGoBack} className="w-full border border-white rounded-md py-3 mt-auto mb-4">
            Go back
          </button>
        </div>
      </div>
